      ...
      <div className="p-5">
        {category && (
          <div className="flex items-center gap-1 mb-3">
            ...
            <span className="text-stealth-cyan text-xs font-medium">{categoryLabels[category] || category}</span>
          </div>
        )}
        ...
        <Link
          href={`/resources/${slug}`}
          className="inline-flex items-center gap-2 text-stealth-cyan text-sm font-medium hover:text-white transition-colors"
        >
